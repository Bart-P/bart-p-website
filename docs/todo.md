...
- [ ] Collect initial screenshots for all proof items
...
- [ ] Implement landing sections from `docs/content-outline.md`
- [ ] Add proof cards and CTA blocks
- [ ] Add FAQ and legal page routes
...
- [ ] Add indexing/Search Console tasks
