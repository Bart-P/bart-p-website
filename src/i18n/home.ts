export const homeContent = {
    en: {
        meta: {
            ...
            description:
                "I help e-commerce teams and agencies turn messy AI workflows, spreadsheets, and fragile automations into reliable internal tools their team can actually use.",
        },
        hero: {
            title: "AI-assisted internal tools for e-commerce teams.",
        ...
        problem: {
            ...
            painPoints: [
                ...
                "Outputs not saved cleanly",
                "Spreadsheets become unofficial internal tools",
        ...
        solution: {
            ...
            transformations: [
                ...
                {
                    from: "Spreadsheet workflow",
                    to: "database-backed tool",
                    description:
            ...
            cards: [
                {
                    ...
                    bestFor: [
                        "Messy prompt workflows",
                        "Fragile n8n / Make / Zapier flows",
        ...
        proof: {
            ...
            title: "Selected work",
            intro: "A few examples of the kind of systems I build:",
            projects: [
                {
                    name: "Listegy",
                    description:
