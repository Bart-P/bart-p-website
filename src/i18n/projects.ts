export const projectsContent = {
    en: {
        ...
        hero: {
            ...
            info:
                "Each project shows the same pattern: messy workflows, scattered data, or repeated decisions turned into something more structured and usable.",
            image: {
        ...
        projects: [{
            ...
            images: ["/assets/listegy/listegy_text_generation.png", "/assets/listegy/listegy_selection.png", "/assets/listegy/listegy_generation.png"],
        }, {
            ...
            stack: ["n8n", "Google Drive", "AI workflows", "Image generation"],
            status: "delivered",
    ...
    de: {
        ...
        hero: {
            ...
            info:
                "Einige Projekte sind intern oder noch in Entwicklung. Deshalb liegt der Fokus hier auf dem Problem, der Struktur und darauf, was die Arbeit zeigt.",
            image: {
                src: "../../assets/projects_hero_image.png",
            },
        },
